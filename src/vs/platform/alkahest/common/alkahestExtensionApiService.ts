/*---------------------------------------------------------------------------------------------
 *  Alkahest Extension API Service
 *--------------------------------------------------------------------------------------------*/
...
export const IAlkahestExtensionApiService = createDecorator<IAlkahestExtensionApiService>('alkahestExtensionApiService');

export interface IAlkahestExtensionApiService {
...
export class AlkahestExtensionApiService implements IAlkahestExtensionApiService {
	...
	async callCommand(command: string, args?: unknown): Promise<ExtCommandResult> {
		...
		if (!namespace || !action) {
			throw new Error(`[AlkahestExtensionApiService] malformed command id: "${command}"`);
		}
...
registerSingleton(IAlkahestExtensionApiService, AlkahestExtensionApiService, InstantiationType.Delayed);
