/*---------------------------------------------------------------------------------------------
 *  Alkahest Task Service
 *  Bridges VS Code's task runner to the Rust `alkahest-tasks` crate via Tauri IPC.
 *
...
export const IAlkahestTaskService = createDecorator<IAlkahestTaskService>('alkahestTaskService');

export interface IAlkahestTaskService extends AlkahestTaskService {
	readonly _serviceBrand: undefined;
}

// ── Service implementation ─────────────────────────────────────────────────────

export class AlkahestTaskService {
...
registerSingleton(IAlkahestTaskService, AlkahestTaskService, InstantiationType.Delayed);
