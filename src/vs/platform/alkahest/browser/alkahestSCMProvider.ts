/*---------------------------------------------------------------------------------------------
 *  Alkahest SCM Provider
 *  High-level wrapper that routes Source Control operations through the Rust
 *  `alkahest-git` crate via Tauri IPC, intended for consumers that need a
...
export const IAlkahestSCMProviderService = createDecorator<IAlkahestSCMProviderService>('alkahestSCMProviderService');

export interface IAlkahestSCMProviderService extends AlkahestSCMProvider {
	readonly _serviceBrand: undefined;
}

export class AlkahestSCMProvider {
...
registerSingleton(IAlkahestSCMProviderService, AlkahestSCMProvider, InstantiationType.Delayed);
