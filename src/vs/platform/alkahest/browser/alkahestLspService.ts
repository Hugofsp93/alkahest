/*---------------------------------------------------------------------------------------------
 *  Alkahest LSP Service
 *  Thin wrapper around the Rust `alkahest-lsp` crate via Tauri IPC. Spawns
...
export const IAlkahestLspService = createDecorator<IAlkahestLspService>('alkahestLspService');

export interface IAlkahestLspService extends AlkahestLspService {
	readonly _serviceBrand: undefined;
}

export class AlkahestLspService {
...
registerSingleton(IAlkahestLspService, AlkahestLspService, InstantiationType.Delayed);
