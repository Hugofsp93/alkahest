/*---------------------------------------------------------------------------------------------
 *  Alkahest DAP Service
 *  Thin wrapper around the Rust `alkahest-dap` crate via Tauri IPC. Exposes the
...
export const IAlkahestDapService = createDecorator<IAlkahestDapService>('alkahestDapService');

export interface IAlkahestDapService extends AlkahestDapService {
	readonly _serviceBrand: undefined;
}

export class AlkahestDapService {
...
registerSingleton(IAlkahestDapService, AlkahestDapService, InstantiationType.Delayed);
