/*---------------------------------------------------------------------------------------------
 *  Alkahest — Remote development service.
 *  Thin TypeScript wrapper over the Tauri commands backed by the
 *  `alkahest-remote` crate (SSH, WSL, Dev Containers, Codespaces).
 *
...
export const IAlkahestRemoteService = createDecorator<IAlkahestRemoteService>('alkahestRemoteService');

export interface IAlkahestRemoteService extends AlkahestRemoteService {
	readonly _serviceBrand: undefined;
}

export class AlkahestRemoteService {
...
let _instance: AlkahestRemoteService | null = null;

export function getAlkahestRemoteService(): AlkahestRemoteService {
	if (!_instance) {
		_instance = new AlkahestRemoteService();
	}
	return _instance;
}

registerSingleton(IAlkahestRemoteService, AlkahestRemoteService, InstantiationType.Delayed);
