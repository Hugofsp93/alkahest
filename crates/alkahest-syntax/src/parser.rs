...
/// Convert a [`alkahest_text::EditOperation`] + [`alkahest_text::Buffer`] into a
/// tree-sitter [`InputEdit`].
///
/// The buffer should reflect the state **before** the edit was applied.
#[must_use]
pub fn to_input_edit(edit: &alkahest_text::EditOperation, buffer: &alkahest_text::Buffer) -> InputEdit {
...
mod tests {
    use super::*;
    use crate::language::Language as AlkahestLanguage;

    fn make_rust_lang() -> AlkahestLanguage {
        AlkahestLanguage {
            name: "rust".into(),
    ...
    fn to_input_edit_insert() {
        let buffer = alkahest_text::Buffer::from_str("fn main() {}");
        let edit_op = alkahest_text::EditOperation::insert(
            alkahest_text::Position::new(0, 11),
            " let x = 1;".into(),
        );
    ...
    fn to_input_edit_delete() {
        let buffer = alkahest_text::Buffer::from_str("fn main() { let x = 1; }");
        let edit_op = alkahest_text::EditOperation::delete(alkahest_text::Range::new(
            alkahest_text::Position::new(0, 11),
            alkahest_text::Position::new(0, 23),
        ));
