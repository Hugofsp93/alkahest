//! Extension host management for `Alkahest` — Node.js extension host + WASM
//! extensions.
//!
//! This crate provides:
//!
...
//!   `Alkahest` WASM `alkahest.toml` manifests, build init-data payloads.
...
pub use paths::{
    global_storage_dir, resolve_node_runtime, alkahest_data_dir, user_data_dir, user_extensions_dir,
    NodeRuntime,
};
pub use protocol::{
