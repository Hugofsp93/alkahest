...
/// Default marketplace base URL. Points at the `Alkahest` Cloudflare
...
fn build_http_client() -> reqwest::Client {
    reqwest::Client::builder()
        .user_agent(concat!(
            ...
            " (+https://github.com/Hugofsp93/alkahest)"
        ))
...
impl MarketplaceClient {
    ...
    pub fn new() -> Self {
        Self {
            ...
            cache_dir: std::env::temp_dir().join("alkahest-marketplace-cache"),
