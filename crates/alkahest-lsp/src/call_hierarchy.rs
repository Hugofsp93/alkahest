...
pub struct CallHierarchyItemInfo {
    ...
    pub selection_range: alkahest_text::Range,
...
pub struct IncomingCall {
    ...
    pub from_ranges: Vec<alkahest_text::Range>,
}
...
impl CallHierarchyService {
    ...
    pub async fn prepare(
        client: &LspClient,
        uri: &str,
        position: alkahest_text::Position,
...
mod tests {
    ...
    fn call_hierarchy_item_info_serde() {
        let info = CallHierarchyItemInfo {
            ...
            range: alkahest_text::Range::new(
                ...
                alkahest_text::Position::new(5, 1),
            ),
            selection_range: alkahest_text::Range::new(
                alkahest_text::Position::new(0, 3),
                alkahest_text::Position::new(0, 7),
            ),
    ...
    fn call_hierarchy_item_symbol_kind() {
        let info = CallHierarchyItemInfo {
            ...
            uri: "file:///t.rs".into(),
            range: alkahest_text::Range::new(alkahest_text::Position::ZERO, alkahest_text::Position::ZERO),
            selection_range: alkahest_text::Range::new(
    ...
    fn incoming_call_serde() {
        let call = IncomingCall {
            from: CallHierarchyItemInfo {
                ...
                uri: "file:///a.rs".into(),
                range: alkahest_text::Range::new(
                    alkahest_text::Position::new(10, 0),
                    alkahest_text::Position::new(20, 1),
                ),
                selection_range: alkahest_text::Range::new(
                    alkahest_text::Position::new(10, 3),
                    alkahest_text::Position::new(10, 9),
                ),
                detail: None,
                raw: None,
            },
            from_ranges: vec![alkahest_text::Range::new(
                alkahest_text::Position::new(15, 4),
                alkahest_text::Position::new(15, 10),
            )],
        };
    ...
    fn outgoing_call_serde() {
        let call = OutgoingCall {
            to: CallHierarchyItemInfo {
                ...
                range: alkahest_text::Range::new(
                    alkahest_text::Position::new(0, 0),
                    alkahest_text::Position::new(3, 1),
                ),
                selection_range: alkahest_text::Range::new(
                    alkahest_text::Position::new(0, 3),
                    alkahest_text::Position::new(0, 9),
                ),
                detail: None,
                raw: None,
            },
