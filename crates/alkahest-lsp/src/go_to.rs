...
pub struct NavigationEntry {
    pub uri: String,
    pub position: alkahest_text::Position,
...
impl NavigationHistory {
    ...
    pub fn push(&mut self, uri: String, position: alkahest_text::Position) {
    ...
    pub fn go_back(
        &mut self,
        current_uri: &str,
        current_pos: alkahest_text::Position,
...
impl GoToService {
    ...
    pub fn go_back(
        ...
        current_uri: &str,
        current_pos: alkahest_text::Position,
    ) -> Option<(String, alkahest_text::Position)> {
        self.history
...
mod tests {
    ...
    fn location_serialize() {
        let loc = Location {
            ...
            range: alkahest_text::Range::new(
                alkahest_text::Position::new(1, 2),
                alkahest_text::Position::new(3, 4),
            ),
        };
    ...
    fn navigation_history_push_and_back() {
        ...
        history.push("file:///a.rs".into(), alkahest_text::Position::new(1, 0));
        history.push("file:///b.rs".into(), alkahest_text::Position::new(5, 0));

        assert!(history.can_go_back());
        assert!(!history.can_go_forward());

        let entry = history
            .go_back("file:///c.rs", alkahest_text::Position::new(10, 0))
            .unwrap();
    ...
    fn navigation_history_forward() {
        let mut history = NavigationHistory::new(10);
        history.push("file:///a.rs".into(), alkahest_text::Position::new(1, 0));
        history.go_back("file:///b.rs", alkahest_text::Position::new(2, 0));

        let entry = history
            .go_forward("file:///b.rs", alkahest_text::Position::new(2, 0))
            .unwrap();
    ...
    fn navigation_history_push_clears_forward() {
        ...
        history.go_back("file:///b.rs", alkahest_text::Position::new(2, 0));
        assert!(history.can_go_forward());
        history.push("file:///c.rs".into(), alkahest_text::Position::new(3, 0));
        assert!(!history.can_go_forward());
    }
    ...
    fn navigation_history_max_size() {
        ...
        for i in 0..5 {
            history.push(format!("file:///{i}.rs"), alkahest_text::Position::new(i, 0));
        }
    ...
    fn navigation_history_clear() {
        let mut history = NavigationHistory::new(10);
        history.push("file:///a.rs".into(), alkahest_text::Position::ZERO);
        history.clear();
        assert!(!history.can_go_back());
        assert!(!history.can_go_forward());
    }
    ...
    fn resolve_single_one_location() {
        let locs = vec![Location {
            uri: "file:///a.rs".into(),
            range: alkahest_text::Range::new(
                alkahest_text::Position::new(0, 0),
                alkahest_text::Position::new(0, 5),
            ),
        }];
