...
impl SelectionRange {
    ...
    pub fn all_ranges(&self) -> Vec<alkahest_text::Range> {
...
impl SelectionRangeService {
    pub async fn provide_selection_ranges(
        client: &LspClient,
        uri: &str,
        positions: &[alkahest_text::Position],
...
mod tests {
    ...
    fn selection_range_serde() {
        let range = SelectionRange {
            range: alkahest_text::Range::new(
                alkahest_text::Position::new(5, 4),
                alkahest_text::Position::new(5, 10),
            ),
            parent: Some(Box::new(SelectionRange {
                range: alkahest_text::Range::new(
                    alkahest_text::Position::new(5, 0),
                    alkahest_text::Position::new(5, 30),
                ),
                parent: None,
            })),
        };
        ...
        let range = SelectionRange {
            ...
            parent: Some(Box::new(SelectionRange {
                ...
                parent: Some(Box::new(SelectionRange {
                    range: alkahest_text::Range::new(
                        alkahest_text::Position::ZERO,
                        alkahest_text::Position::new(100, 0),
                    ),
                    parent: None,
                })),
            })),
    ...
    fn selection_range_no_parent() {
        let range = SelectionRange {
            range: alkahest_text::Range::new(
                alkahest_text::Position::ZERO,
                alkahest_text::Position::new(0, 10),
            ),
            parent: None,
        };
